...
// Read-only: which branch and file the editor is showing. Every other repository
// operation (branch, checkout, commit, push, pull, merge) is the user's own `git`,
// run outside Hoskinator — see CLAUDE.md's "pure editor" decision.
